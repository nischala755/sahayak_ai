...
export default function SOSPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await sosAPI.quick(
        input,
        subject || null,
        grade || null,
        language,
        ...
        <div className="bg-amber-50 border-b border-amber-200 py-3 px-4">
          <div className="max-w-4xl mx-auto flex items-center gap-3">
            ...
            <span className="text-amber-800 text-sm font-medium">
              📴 You're offline - showing cached results if available
            </span>
          </div>
        </div>
      )}

      {/* Cache Indicator (shown when result is from cache) */}
      {result?.from_cache && (
        <div className="bg-blue-50 border-b border-blue-200 py-2 px-4">
          <div className="max-w-4xl mx-auto flex items-center gap-3">
            <Zap className="w-4 h-4 text-blue-600" />
            <span className="text-blue-800 text-sm">
              ⚡ Instant response from cache ({result.processing_time_ms}ms)
            </span>
          </div>
        </div>
      )}
            ...
            >
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-slate-600 max-w-lg mx-auto">
                  Describe your classroom problem using voice or text. Our AI
                  will generate an instant teaching rescue playbook.
                </p>
              </div>
                  ...
                  <div className="mb-6">
                    ...
                    <div className="space-y-2">
                      {result.playbook.immediate_actions.map((action, i) => (
                        ...
                        >
                          <span className="step-number bg-red-500 flex-shrink-0">
                            {i + 1}
                          </span>
                      ...
                      {result.playbook.youtube_videos.map((video, i) => (
                        ...
                        >
                          ...
                          <div className="flex-1">
                            <p className="font-medium text-slate-800 group-hover:text-red-600">
                              {video.title}
                            </p>
                            {video.description && (
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      {result.playbook.teaching_resources.map((resource, i) => (
                        <div
                          key={i}
                          className="flex items-center gap-2 p-2 bg-purple-50 rounded-lg text-slate-700"
                        >
